...
(lib.Tween2 = function(mode,startPosition,loop) {
	...
	this.instance.setTransform(-170.7,-256.1,1.067,1.067);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-170.7,-256.1,341.5,512.2);
...
(lib.TALENT_1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Layer 1
	this.instance = new lib.TALENT();
	this.instance.parent = this;
	this.instance.setTransform(-131.7,-197.5,0.823,0.823);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-131.7,-197.5,263.5,395.2);


(lib.GARASI = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
...
p.nominalBounds = new cjs.Rectangle(-60.6,-20.6,185.7,278.6);
...
(lib._320x50 = function(mode,startPosition,loop) {
	...
	this.instance_7.setTransform(75,-38.1,0.9,0.9,0,0,0,0.3,0.2);
	...
	// LOGOMB copy
	this.instance_9 = new lib.LOGOMB_1("synched",0);
	this.instance_9.parent = this;
	this.instance_9.setTransform(34.7,35.7,0.32,0.32,0,0,0,1.7,1.2);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_9).wait(9).to({startPosition:0},0).wait(1).to({startPosition:0},0).to({regX:2.5,regY:1.4,scaleX:0.24,scaleY:0.24,x:25.8,y:25.5},12).wait(99));
	...
	this.instance_10.setTransform(35.2,35.7,0.32,0.32,0,0,0,1.7,1.2);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).wait(9).to({startPosition:0},0).wait(1).to({startPosition:0},0).to({regX:2.5,regY:1.4,scaleX:0.24,scaleY:0.24,x:25.8,y:26},12).wait(99));

	// SHADOWred
	this.instance_11 = new lib.SHADOWRED_1("synched",0);
	this.instance_11.parent = this;
	this.instance_11.setTransform(33.2,25.3,0.258,0.258,0,0,0,0.4,0.6);
	this.instance_11.alpha = 0.469;

	this.timeline.addTween(cjs.Tween.get(this.instance_11).to({alpha:1},2).to({alpha:0.352},4).to({startPosition:0},3).to({startPosition:0},1).to({regX:-0.2,regY:0.8,scaleX:0.18,scaleY:0.18,x:-64,y:29.2,alpha:0},12).wait(99));

	// BG
	this.instance_12 = new lib.BG_2("synched",0);
	this.instance_12.parent = this;
	this.instance_12.setTransform(150,291.3,1.539,1);

	this.timeline.addTween(cjs.Tween.get(this.instance_12).wait(9).to({startPosition:0},0).to({alpha:0},15).wait(97));

	// AWAn
	this.instance_13 = new lib.Tween1("synched",0);
	this.instance_13.parent = this;
	this.instance_13.setTransform(142.5,46.5,1.108,1.108,0,0,0,0.1,0.1);

	this.instance_14 = new lib.Tween2("synched",0);
	this.instance_14.parent = this;
	this.instance_14.setTransform(164.7,28.8,1.108,1.108,0,0,0,0.1,0.1);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_13}]}).to({state:[{t:this.instance_14}]},120).wait(1));
	this.timeline.addTween(cjs.Tween.get(this.instance_13).to({_off:true,x:164.7,y:28.8},120).wait(1));

	// MOTOR
	this.instance_15 = new lib.TALENT_1("synched",0);
	this.instance_15.parent = this;
	this.instance_15.setTransform(172.8,22.7,0.48,0.48,0,0,0,0.2,0.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_15).to({scaleX:0.56,scaleY:0.56,x:177.5,y:9.3},7).to({regX:0.3,regY:0,scaleX:0.63,scaleY:0.63,x:181.1,y:-0.6},113).wait(1));

	// GARASi
	this.instance_16 = new lib.GARASI("synched",0);
	this.instance_16.parent = this;
	this.instance_16.setTransform(124.9,-43.5,1.189,1.189,0,0,0,0.1,0.1);

	this.timeline.addTween(cjs.Tween.get(this.instance_16).to({x:185.9},69).wait(52));

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(79.2,-304,485.3,920.3);
// library properties:
lib.properties = {
	width: 320,
	height: 50,
	...
	manifest: [
		...
		{src:"images/WINYOU.png", id:"WINYOU"},
